...
CREATE TABLE `admin`  (
  ...
  `a_pass` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `users`  (
  ...
  `upass` char(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
...
CREATE TABLE `xmorder`  (
  ...
  `odate` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
